...
class Classifier_INCEPTION:
    ...
    def __init__(self, output_directory, input_shape, nb_classes, verbose=True, build=True, batch_size=16,
    ...
    def fit(self, x_train, y_train, x_val, y_val, y_true, plot_test_acc=False):
        print("Running fit which calls save logs") 
        # if len(keras.backend.tensorflow_backend._get_available_gpus()) == 0:
        # if len(keras.config.list_physical_devices('GPU')) == 0:
        #     print('error no gpu')
        #     exit()
